...
<html lang="en">
	...
	<body>
                            ...
                            <li>
								<a href="assign_subject.html">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title">Assigning Subject To Teacher </span>
										</div>
									</div>
								</a>
							</li>
                            <li>
								<a href="staff_payment.html">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Staff Payment &amp; Status </span>
										</div>
									</div>
								</a>
							</li>
                            <li>
								<a href="staff_view.html">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Staff View </span>
										</div>
									</div>
								</a>
							</li>
                            <li>
								<a href="student_view.html">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Student View </span>
										</div>
									</div>
								</a>
							</li>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Student Data Information</h1>
									<span class="mainDescription">Student Data.</span>
								</div>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
                        ...
                        <div class="col-sm-12">
                            <div class="checkbox clip-check check-primary">
                                ...
                                <label for="checkbox2">
                                    Including Old Students
                                </label>
                            </div>
                        </div>
                        <a href="#modalwin" class="btn btn-primary btn-o clk" data-toggle="modal" data-target="">
																	Review &amp; Confirm
																</a>
						<!-- start: DYNAMIC TABLE -->
										...
										<table class="table table-striped table-hover" id="myTable">
											...
											<tbody>
												<tr class="clk">
                                                    ...
                                                    <td>0213-4534678</td>
													<td>
													<a href="#modalwin1" class="edit-row" data-toggle="modal" data-target="#modalwin1">
														Edit
													</a></td>
													<td>
												...
												<tr class="clk">
                                                    ...
                                                    <td>0213-5545278</td>
													<td>
													<a href="#modalwin2" class="edit-row" data-toggle="modal" data-target="#modalwin2">
														Edit
													</a></td>
													<td>
													<a href="#" class="delete-row">
												...
												<tr class="clk">
                                                    ...
                                                    <td>0213-5741557</td>
													<td>
													<a href="#modalwin3" class="edit-row" data-toggle="modal" data-target="#modalwin3">
														Edit
													</a></td>
													<td>
													<a href="#" class="delete-row">
												...
												<tr class="clk">
                                                    ...
                                                    <td>0213-6241420</td>
													<td>
													<a href="#modalwin4" class="edit-row" data-toggle="modal" data-target="#modalwin4">
														Edit
													</a></td>
													<td>
													<a href="#" class="delete-row">
												...
												<tr class="clk">
                                                    ...
                                                    <td>0213-5435368</td>
													<td>
													<a href="#modalwin5" class="edit-row" data-toggle="modal" data-target="#modalwin5">
														Edit
													</a></td>
													<td>
													<a href="#" class="delete-row">
        ...
        <!-- Large Modal -->
        <div class="modal fade bs-example-modal-lg" id="modalwin1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Asim" class="form-control" id="firstname" name="firstname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Last Name
                                            </label>
                                            <input type="text" placeholder="Sheikh" class="form-control" id="lastname" name="lastname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Email Address
                                            </label>
                                            <input type="email" placeholder="asim_s54y@gmail.com" class="form-control" id="email" name="email">
                                        </div>
                                       	<div class="form-group">
                                            <label for="exampleInputGender">
                                                P-ID
                                            </label>
                                            <input type="text" class="form-control" value="" placeholder="45425" id="extra3" name="extra3" onkeypress="return isNumber(event)">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Phone
                                            </label>
                                            <input type="email" placeholder="(0213)-453-4678" class="form-control" id="phone" name="email">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="12345" value="" id="extra4" name="extra4" onkeypress="return isNumber(event)">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control tooltips" placeholder="Karachi" type="text" data-original-title="We'll display it when you write reviews" data-rel="tooltip" title="" data-placement="top" name="city" id="city">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
		...
		<div class="modal fade bs-example-modal-lg" id="modalwin2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog modal-lg">
                <div class="modal-content" style="background-color: #fff;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Ali" class="form-control" id="firstname" name="firstname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Last Name
                                            </label>
                                            <input type="text" placeholder="Yousaf" class="form-control" id="lastname" name="lastname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Email Address
                                            </label>
                                            <input type="email" placeholder="ali54y@gmail.com" class="form-control" id="email" name="email">
                                        </div>
                                       	<div class="form-group">
                                            <label for="exampleInputGender">
                                                P-ID
                                            </label>
                                            <input type="text" class="form-control" value="" placeholder="33352" id="extra1" name="extra1" onkeypress="return isNumber(event)">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Phone
                                            </label>
                                            <input type="email" placeholder="(0213)-554-5278" class="form-control" id="phone" name="email">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputAddress">
                                                Address
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="12345" value="" id="extra2" name="extra2" onkeypress="return isNumber(event)">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
        ...
        <div class="modal fade bs-example-modal-lg" id="modalwin3" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog modal-lg">
                <div class="modal-content" style="background-color: #fff;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Babar" class="form-control" id="firstname" name="firstname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Last Name
                                            </label>
                                            <input type="text" placeholder="Azam" class="form-control" id="lastname" name="lastname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Email Address
                                            </label>
                                            <input type="email" placeholder="babar_a100y@hotmail.com" class="form-control" id="email2" name="email">
                                        </div>
                                       	<div class="form-group">
                                            <label for="exampleInputGender">
                                                P-ID
                                            </label>
                                            <input type="text" class="form-control" value="" placeholder="25463" id="extra5" name="extra5" onkeypress="return isNumber(event)">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Phone
                                            </label>
                                            <input type="email" placeholder="(0213)-574-1557" class="form-control" id="phone" name="email">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputAddress">
                                                Address
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="12345" value="" id="extra6" name="extra6" onkeypress="return isNumber(event)">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Waqar" class="form-control" id="firstname1" name="firstname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Last Name
                                        ...
                                        <div class="form-group">
                                       	...
                                       	<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="" placeholder="28874" id="extra7" name="extra7" onkeypress="return isNumber(event)">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Phone
                                            </label>
                                            <input type="email" placeholder="(0213)-624-1420" class="form-control" id="phone" name="email">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputAddress">
                                                Address
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="12345" value="" id="extra8" name="extra8" onkeypress="return isNumber(event)">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
        ...
        <div class="modal fade bs-example-modal-lg" id="modalwin5" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog modal-lg">
                <div class="modal-content" style="background-color: #fff;">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Samina" class="form-control" id="firstname" name="firstname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Last Name
                                            </label>
                                            <input type="text" placeholder="Khan" class="form-control" id="lastname" name="lastname">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Email Address
                                            </label>
                                            <input type="email" placeholder="saim_421@hotmail.com" class="form-control" id="email1" name="email">
                                        </div>
                                       	<div class="form-group">
                                            <label for="exampleInputGender">
                                                P-ID
                                            </label>
                                            <input type="text" class="form-control" value="" placeholder="25741" id="extra9" name="extra9" onkeypress="return isNumber(event)">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">
                                                Phone
                                            </label>
                                            <input type="email" placeholder="(0213)-543-5368" class="form-control" id="phone" name="email">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputAddress">
                                                Address
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="12345" value="" id="extra10" name="extra10" onkeypress="return isNumber(event)">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="form-group">
    ...
    <script src="test/src/jquery.ui.position.js" type="text/javascript"></script>
    <script src="test/src/jquery.contextMenu.js" type="text/javascript"></script>
    <script src="test/screen.js" type="text/javascript"></script>
    <script src="test/prettify/prettify.js" type="text/javascript"></script>
    ...
    <link href="test/prettify/prettify.sunburst.css" rel="stylesheet" type="text/css" />
...
function test(){
	//window.location = 'student_view.html#modalwin';
    ...
    for(var i=0;i<obj.length;i++){
      ...
      '<tr class="clk"><td><input type="checkbox" id="checkbox2" value="1"></td>',
	  '<td>'+name+'</td>',
	  '<td>'+id+'</td>',
	  '<td>'+classes+'</td>',
	  '<td>'+shift+'</td>',
	  '<td>'+contact+'</td>',
	  '<a href="#modalwin?id='+id+'" onclick="set_data('+id+')" class="edit-row" data-toggle="modal" data-target="#modalwin4">Edit</a>',
	  '<td><a href="?id='+obj[key]+'" class="delete-row">Delete</a></td></tr>'
       ] );
    }
