...
insert  into `expences`(`exp_name`,`exp_id`,`exp_discription`,`account_id`) values ('new_nw',2,'detail',1),('new_nw',3,'detail',1);
...
insert  into `fee_concession`(`Student_Id`,`Fee_Id`,`Status_Id`,`Waived_Ammount`) values (1,1,1,100),(1,2,1,200),(1,1,1,100);
...
insert  into `fee_due`(`Student_Id`,`Fee_Id`,`Status_Id`,`account_id`) values (1,1,1,1),(1,1,1,1);
...
insert  into `fee_recived`(`Student_Id`,`Fee_Id`,`Recived_Amount`,`Date`,`Time_Stamp`) values (12,12,12222,NULL,'2015-06-17 16:03:08'),(12,12,12222,'2015-06-17 15:53:07','2015-06-17 16:03:08'),(12,12,12222,'0000-00-00 00:00:00','2015-06-17 16:03:08'),(12,12,12222,'0000-00-00 00:00:00','2015-06-17 16:03:08'),(12,12,12222,'2015-06-17 15:58:54','2015-06-17 16:03:08'),(12,12,12222,'2015-06-17 15:59:06','2015-06-17 16:03:08');
...
insert  into `fee_type`(`Fee_Id`,`Name`,`Fee_description`,`Late_Fee`,`Fee_Applicable`,`Class_Id`,`Threshold`) values (12,'naveed','dvsdfvsdvsmvlsd','12','10',1,'vsdfsd');
