...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2015 at 08:48 AM
...
(1, 28500, 0, '2015-02-24 08:17:35'),
(9, 0, 28500, '2015-02-24 08:17:35');
...
INSERT INTO `applications` (`appID`, `appname`, `appdisc`, `registrationdate`, `app_key`) VALUES
(1, 'glob_testing', 'global testing application', '2015-02-22 19:00:00', ''),
(2, 'dfasd', 'dfasd', '2015-02-26 10:59:17', '67daab1131d76b9950f2fea794d17fda'),
(3, 'dfasd', 'dfasd', '2015-02-26 11:04:41', '0c380373e79e2b152c61809c72a0f200'),
(4, 'dfasd', 'dfasd', '2015-02-26 11:05:43', 'a4ae57a030f6ae24238975a01c9d64dd'),
(5, 'dfasd', 'dfasd', '2015-02-26 11:06:16', 'd97b391fad87b523f92874514c95bc53'),
(6, 'tariq', 'tariq ali app', '2015-02-26 11:06:44', 'c97a163da16ba3aa36fe80ba6f983d98'),
(7, 'tiek', 'tiek123', '2015-03-02 13:24:50', 'c946a228808c9b759494f9d666abedc1'),
(8, 'tariq ali', 'tarqi ali desc', '2015-03-02 13:29:15', 'beb0ce2a9a9ac26c69878ac2a790cf39'),
(9, 'my app', 'testing application', '2015-03-03 08:23:16', '04780c22ee3f80acc8ad1aaf8032b67c'),
(10, 'my app 2', 'testing application', '2015-03-03 11:25:19', '925a094ac5a421ee917489501e71e498'),
(11, 'tiekapp2', 'testing application', '2015-03-03 11:44:06', '65a1fede9361f46ee87d4542bab2c1ce'),
(12, 'tariqapp123', 'tariq app 123', '2015-03-10 11:10:44', '3654330402a5826100c8154122aaa6de'),
(14, 'tariq_ali_is', 'tariq app is the best', '2015-03-10 11:56:23', 'a2ebce995c136da787e6c998143f0415');
...
('my app 2_15', '1425381944', 50000),
('tariq ali_14', '1425371305', 50000),
('tiekapp2_16', '1425383070', 50000);
...
--
-- Dumping data for table `loginvalidity`
--

INSERT INTO `loginvalidity` (`validity`, `calls_valid`) VALUES
(50000, 10);
...
(19, '1', 1, 'Provided services to its customers and received $28,500 in cash.', '2015-01-13', '12:00:00');
...
(37, 19, 1, 28500, 0, '2015-02-24 08:17:35'),
(38, 19, 9, 0, 28500, '2015-02-24 08:17:35');
...
INSERT INTO `users` (`userID_local`, `userID_caller`, `appID`, `appauthlevel`, `last_call`, `count`) VALUES
('glob_1', 1, '1', 'full', '0000-00-00 00:00:00', 0),
('my app 2_15', 37, '10', 'full', '2015-03-03 11:25:44', 0),
('tariq ali_14', 145, '8', 'full', '2015-03-03 08:29:18', 0),
('tariqapp123_17', 80, '12', 'full', '2015-03-10 11:13:08', 12),
('tariq_10', 15, '6', 'full', '2015-02-27 07:00:47', 0),
('tariq_11', 20, '6', 'full', '2015-02-27 07:32:50', 0),
('tariq_12', 25, '6', 'full', '2015-02-27 10:54:00', 0),
('tariq_13', 133, '6', 'full', '2015-03-02 13:20:21', 3),
('tariq_2', 2, '6', 'full', '2015-02-26 11:49:36', 0),
('tariq_3', 3, '6', 'full', '2015-02-27 07:25:21', 0),
('tariq_4', 4, '6', 'full', '2015-02-26 11:53:25', 0),
('tariq_5', 5, '6', 'full', '2015-02-26 11:53:58', 0),
('tariq_6', 6, '6', 'full', '2015-02-27 06:52:51', 0),
('tariq_7', 10, '6', 'full', '2015-02-27 13:17:03', 0),
('tariq_8', 9, '6', 'full', '2015-02-27 06:54:04', 0),
('tariq_9', 11, '6', 'full', '2015-02-27 10:04:42', 0),
('tiekapp2_16', 46, '11', 'full', '2015-03-10 09:37:34', 0);
...
--
ALTER TABLE `users`
 ADD PRIMARY KEY (`userID_local`), ADD UNIQUE KEY `userID_caller` (`userID_caller`);
