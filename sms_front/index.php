            ...
            <section id="content">
                ...
                <div class="admin-form theme-info" id="login1">
                    ...
                    <div class="panel panel-info mt10 br-n">
                        ...
                        <form method="post" action="dashboard.php" id="contact">
                            ...
                            <div class="panel-footer clearfix p10 ph15">
                                <button type="button" class="button btn-primary mr10 pull-right"><a href="dashboard.php" style="color:white;">Sign In</a></button>
